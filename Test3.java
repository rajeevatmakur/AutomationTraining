...
public class Test3Test {
  ...
  public void test3() {
    ...
    driver.manage().window().setSize(new Dimension(1051, 720));
    ...
    js.executeScript("window.scrollTo(0,499.8290710449219)");
    driver.findElement(By.cssSelector(".button-group > button:nth-child(1)")).click();
    js.executeScript("window.scrollTo(0,557.2649536132812)");
    driver.close();
  }
}
